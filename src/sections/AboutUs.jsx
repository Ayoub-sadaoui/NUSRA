...
const AboutUs = () => {
  return (
    <div className=" md:hidden text-center  inline-flex  w-full gap-[12px] flex-col section-padding">
      <h1 className="font-bold text-primary text-[50px] text-center font-Aljazeera">
        معلومات عنا
      </h1>
      <p className="text-secondary text-2xl sm:text-[26px] px-5 sm:px-10 text-center font-Aljazeera  ">
